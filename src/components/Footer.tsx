    ...
    <footer className="bg-gray-900 text-gray-300 border-t-4 border-[#8d1b20]">
      <div className="container mx-auto px-4 py-8">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div>
            <div className="flex items-center gap-2 mb-4">
              ...
              <div>
                <h3 className="text-lg font-bold text-white">Trusted Gemlab</h3>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-gray-400">
              ...
              <li className="flex items-center gap-2">
                ...
                Gemological Laboratory, Trusted Gemlab
              </li>
            </ul>
          </div>
        </div>
        ...
        <div className="border-t border-gray-800 mt-8 pt-6 text-center">
          <p className="text-sm text-gray-400">
            &copy; {currentYear} Trusted Gemlab. All rights reserved. | Gemological Laboratory Services
          </p>
        </div>
      </div>
    </footer>
