...
export default function CertificateLayout({
  ...
  return (
    <div
      id="certificate"
      className="w-full bg-linear-to-br from-white via-gray-50 to-white p-[2%] relative shadow-2xl overflow-hidden"
      style={{
        aspectRatio: '7 / 4',
        maxWidth: '2100px',
        border: 'none',
    ...
    >
      ...
      {qrValue && (
        <div className="absolute top-[1.5%] right-[1.5%] bg-white p-[0.8%] rounded-md shadow-lg z-30" style={{ width: 'clamp(80px, 7%, 130px)', aspectRatio: '1 / 1' }}>
          ...
          <p className="text-[clamp(6px,0.5vw,9px)] text-center text-gray-600 mt-0.5 font-semibold">SCAN VERIFY</p>
        </div>
      )}
      ...
      <div className="relative z-10 mb-[1.5%]">
        <div className="grid grid-cols-12 gap-2 items-start mb-[1.5%] pb-[1%]">
          ...
          <div className="col-span-2 flex justify-center items-start">
            <div className="w-[clamp(60px,4.5vw,100px)] h-[clamp(60px,4.5vw,100px)] bg-linear-to-br from-[#8d1b20] to-[#c92a2a] rounded-full p-0.5 shrink-0">
      ...
      <div className="relative z-10 grid grid-cols-7 gap-[1.5%] mb-[1.5%]">
        ...
        <div className="col-span-4 space-y-[1.5%] overflow-hidden">
          ...
          <div className="bg-linear-to-r from-[#8d1b20]/5 to-transparent p-[2.5%] rounded-md">
            <p className="text-[clamp(0.55rem,0.7vw,0.85rem)] font-bold text-[#8d1b20] uppercase tracking-widest mb-0.5 leading-tight">Gem Identification</p>
            <p className="text-[clamp(1rem,1.5vw,1.9rem)] font-bold text-gray-900 wrap-break-word leading-tight">{identification}</p>
          </div>
          ...
          <div className="grid grid-cols-2 gap-[2.5%] overflow-hidden">
            <div className="bg-white p-[3%] rounded-md shadow-md" style={{border: '1px solid white'}}>
              <p className="text-[clamp(0.5rem,0.6vw,0.75rem)] font-bold text-gray-500 uppercase tracking-wide mb-0.5 leading-tight">Weight</p>
            ...
            {dimensions && (
              <div className="bg-white p-[3%] rounded-md shadow-md" style={{border: '1px solid white'}}>
                <p className="text-[clamp(0.5rem,0.6vw,0.75rem)] font-bold text-gray-500 uppercase tracking-wide mb-0.5 leading-tight">Dimensions</p>
                <p className="text-[clamp(0.75rem,1.1vw,1.4rem)] font-semibold text-gray-900 wrap-break-word leading-tight">{dimensions} <span className="text-[clamp(0.6rem,0.8vw,1rem)]">mm</span></p>
              </div>
            )}

            {cut && (
              <div className="bg-white p-[3%] rounded-md shadow-md" style={{border: '1px solid white'}}>
                <p className="text-[clamp(0.5rem,0.6vw,0.75rem)] font-bold text-gray-500 uppercase tracking-wide mb-0.5 leading-tight">Cut</p>
                <p className="text-[clamp(0.75rem,1.1vw,1.4rem)] font-semibold text-gray-900 wrap-break-word leading-tight">{cut}</p>
              </div>
            )}

            {shape && (
              <div className="bg-white p-[3%] rounded-md shadow-md" style={{border: '1px solid white'}}>
                <p className="text-[clamp(0.5rem,0.6vw,0.75rem)] font-bold text-gray-500 uppercase tracking-wide mb-0.5 leading-tight">Shape</p>
                <p className="text-[clamp(0.75rem,1.1vw,1.4rem)] font-semibold text-gray-900 wrap-break-word leading-tight">{shape}</p>
              </div>
            )}

            {color && (
              <div className="bg-white p-[3%] rounded-md shadow-md col-span-2" style={{border: '1px solid white'}}>
                <p className="text-[clamp(0.5rem,0.6vw,0.75rem)] font-bold text-gray-500 uppercase tracking-wide mb-0.5 leading-tight">Color</p>
                <p className="text-[clamp(0.75rem,1.1vw,1.4rem)] font-semibold text-gray-900 wrap-break-word leading-tight">{color}</p>
              </div>
            )}
          </div>
          ...
          {(comment1 || comment2) && (
            <div className="bg-amber-50 rounded-md p-[2.5%] overflow-hidden">
              <p className="text-[clamp(0.6rem,0.75vw,0.95rem)] font-bold text-amber-800 uppercase tracking-wide mb-1 flex items-center gap-1 leading-tight">
                <svg className="w-[clamp(12px,1vw,18px)] h-[clamp(12px,1vw,18px)] shrink-0" fill="currentColor" viewBox="0 0 20 20">
                  <path fillRule="evenodd" d="M18 10a8 8 0 11-16 0 8 8 0 0116 0zm-7-4a1 1 0 11-2 0 1 1 0 012 0zM9 9a1 1 0 000 2v3a1 1 0 001 1h1a1 1 0 100-2v-3a1 1 0 00-1-1H9z" clipRule="evenodd" />
                </svg>
                Laboratory Comments
              </p>
              {comment1 && <p className="text-[clamp(0.65rem,0.85vw,1.05rem)] text-gray-900 mb-0.5 leading-snug wrap-break-word">• {comment1}</p>}
              {comment2 && <p className="text-[clamp(0.65rem,0.85vw,1.05rem)] text-gray-900 leading-snug wrap-break-word">• {comment2}</p>}
            </div>
          )}
        </div>
        ...
        <div className="col-span-3 flex flex-col gap-[2%] overflow-hidden">
          ...
          {imageUrl && (
            <div className="bg-white rounded-lg shadow-xl p-[3%] flex-1 min-h-0">
              ...
              <div className="w-full h-[87%] flex items-center justify-center bg-linear-to-br from-gray-50 to-gray-100 rounded-md overflow-hidden">
                <img 
                  src={imageUrl} 
                  alt="Gemstone" 
          ...
          {/* Origin Badge */}
          {origin && (
             <div className="bg-linear-to-br from-[#8d1b20] to-[#c92a2a] rounded-lg p-[4%] shadow-lg text-center overflow-hidden">
              ...
              <p className="text-[clamp(1.3rem,2.2vw,3rem)] font-bold text-white tracking-wide wrap-break-word leading-tight">{origin}</p>
            </div>
          )}
        </div>
      </div>
      ...
      <div className="relative z-10 grid grid-cols-2 gap-[3%] mt-auto">
        <div className="flex items-end overflow-hidden">
          <div className="text-gray-600 bg-gray-100 p-[2.5%] rounded-md w-full">
            <p className="font-semibold text-gray-800 mb-0.5 text-[clamp(0.75rem,0.95vw,1.2rem)] leading-tight">Authenticity Guarantee</p>
            ...
            <div className="text-right">
              {signatureUrl ? (
                <div className="flex flex-col items-end mb-1">
                  <div className="w-[clamp(130px,16vw,280px)] h-[clamp(35px,4.5vw,85px)] flex items-center justify-end mb-0.5 overflow-hidden">
                    <img 
                      src={signatureUrl} 
                      alt="E-Signature" 
              ...
              <p className="font-bold text-gray-900 text-[clamp(0.85rem,1.2vw,1.5rem)] wrap-break-word leading-tight">{certifiedBy}</p>
              <p className="text-[clamp(0.6rem,0.75vw,0.9rem)] text-gray-600 font-semibold leading-tight">Graduate Gemologist AJP</p>
              {verifiedBy && (
                <p className="text-[clamp(0.6rem,0.75vw,0.9rem)] text-gray-500 mt-0.5 wrap-break-word leading-tight">Verified by: {verifiedBy}</p>
              )}
            </div>
          )}
        </div>
